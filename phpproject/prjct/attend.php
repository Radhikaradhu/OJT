...
<nav class="menubar">
  ...
  <div class="container-fluid">
    <a class="text-decoration-none text-white" href="#"><h1>ATTENDANCE</h1></a>
    <div>
      <ul class="navbar-nav">
...
$id=$_SESSION["id"];
$result="select * from attendance where id='$id'";
...
while($row=mysqli_fetch_assoc($res))
{
   ...
   <tr>
   <td>Number Of Days Present:</td> <td><input type="text" name="dayt" value=<?php echo $row['dayt'];?>> </td>
   </tr>
   <tr>
   <td>Percentage:</td> <td><input type="text" name="percentage" value=<?php echo $row['percentage'];?>> </td>
   </tr>
