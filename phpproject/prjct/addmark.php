...
<nav class="menubar">
  ...
  <div class="container-fluid">
    <a class="text-decoration-none text-white" href="#"><h1>ADD MARK</h1></a>
    <div>
      <ul class="navbar-nav">
...
while($row=mysqli_fetch_assoc($res))
{
    ...
    ?>
    <form action="markinsert.php" method="post">
    <table>
    <tr>
   ...
   <tr>
   <td>Total Mark:</td> <td><input type="text" name="mark"> </td>
   </tr>
   <tr>
   <td>Percentage:</td> <td><input type="text" name="percentage"> </td>
   </tr>
   
  <tr><td></td><td><input type="submit" name="edit" value="Add Mark"></td>
