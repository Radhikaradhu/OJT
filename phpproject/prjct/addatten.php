...
while($row=mysqli_fetch_assoc($res))
{
    ...
    ?>
    <form action="atteninsert.php" method="post">
    <table>
    <tr>
   ...
   <tr>
   <td>Number of Days Present:</td> <td><input type="text" name="dayt"> </td>
   </tr>
   <tr>
   <td>Percentage:</td> <td><input type="text" name="percentage"> </td>
   </tr>
   
  <tr><td></td><td><input type="submit" name="edit" value="Add attendance"></td>
